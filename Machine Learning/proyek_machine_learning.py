...
Original file is located at
    https://colab.research.google.com/drive/1bj6KQ6QafK0XiN7Ina-YYRCg3snhrLZ8
...
# download /content/Dataset-Final/test as zip
...
converter = tf.lite.TFLiteConverter.from_saved_model('/content/model_vgg16/')
...
files.download('model_vgg16.tflite')
...
# Ambil urutan label (pastikan ini sesuai dengan model training)
label_names = sorted(df_test['labels'].unique())  # Atau ganti jika punya mapping asli
