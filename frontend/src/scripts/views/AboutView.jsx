...
const AboutView = () => {
  ...
  return (
    <section className="bg-white min-h-screen pt-20 z-50 font-nunito">
      {/* Hero Section */}
      <div className="max-w-full mx-auto flex flex-col pt-8 px-8 pb-0 md:flex-row items-center gap-8 md:pt-16 px-10 lg:px-16 pb-16 pt-16">
      ...
      <section className="relative py-16 px-8 md:px-10 lg:px-14 overflow-hidden w-full max-w-full">
        <div className="w-full px-0 grid grid-cols-1 md:grid-cols-2 items-center gap-8 md:gap-16">
          ...
          <div className="flex flex-col gap-3 z-10 order-2">
            <h2 className="text-4xl md:text-5xl font-extrabold text-primary mb-6 md:mb-0 text-left leading-[2.5rem] md:leading-[3.5rem]">
              Visi & Misi
            </h2>
            <p className="text-primary text-lg mb-8 max-w-2xl">
      ...
      {/* Perjalanan Kami */}
      <section className="max-w-full mx-auto px-8 md:px-10 lg:px-14 mt-20">
