      ...
      <section ref={eduRef} className="w-full mx-auto px-8 md:px-10 lg:px-16 mb-12">
        {selectedCategory === 'plastik' && (
          <>
            ...
            <p className="font-medium text-primary mb-6 text-sm md:text-base">
              Sampah plastik membutuhkan waktu ratusan tahun untuk terurai.
        ...
        {selectedCategory === 'kertas' && (
          <>
            ...
            <p className="font-medium text-primary mb-6 text-sm md:text-base">
              Kertas adalah salah satu sampah yang mudah terurai dan dapat
              didaur ulang menjadi produk baru. Pemilahan kertas membantu
              ...
              <article className="bg-white rounded-xl shadow p-0 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 p-6 flex flex-col justify-center">
                  ...
                  <p className="font-medium text-primary text-sm md:text-base">
                    ...
                    untuk menghemat ruang. Simpan di tempat kering untuk menjaga
                    kualitas kertas.
                  </p>
                </div>
              </article>
        ...
        {selectedCategory === 'logam' && (
          <>
            ...
            <p className="font-medium text-primary mb-6 text-sm md:text-base">
              Logam adalah material yang dapat didaur ulang berkali-kali tanpa
              mengurangi kualitasnya. Proses daur ulang logam menghemat energi
        ...
        {selectedCategory === 'kaca' && (
          <>
            ...
            <p className="font-medium text-primary mb-6 text-sm md:text-base">
              Kaca dapat didaur ulang 100% dan dapat diproses berulang kali
              tanpa penurunan kualitas. Daur ulang kaca menghemat energi dan
              mengurangi limbah.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <article className="bg-white rounded-xl shadow p-0 flex flex-col overflow-hidden">
        ...
        {selectedCategory === 'organik' && (
          <>
            ...
            <p className="font-medium text-primary mb-6 text-sm md:text-base">
              Sampah organik dapat dikompos menjadi pupuk yang bermanfaat untuk
              tanaman. Pengomposan mengurangi volume sampah dan menghasilkan
              nutrisi untuk tanah.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <article className="bg-white rounded-xl shadow p-0 flex flex-col overflow-hidden">
