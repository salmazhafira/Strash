...
import { useNavigate, useLocation } from 'react-router-dom'; // Import useNavigate for redirection and useLocation for navigation state
...
function ContentSection({ activeTab, userData }) {
  ...
  const handleSave = (e) => {
    ...
    Swal.fire({
      ...
      text: 'Fitur simpan perubahan sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
      icon: 'info',
        ...
        <form className="flex flex-col gap-5">
          ...
          <button
            ...
            onClick={(e) => {
              ...
              Swal.fire({
                title: 'Fitur Segera Hadir!',
                text: 'Fitur perbarui password sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                icon: 'info',
                confirmButtonText: 'Mengerti',
                confirmButtonColor: '#2C6B3F',
                customClass: {
        ...
        <form className="flex flex-col gap-5">
          ...
          <button
            ...
            onClick={(e) => {
              ...
              Swal.fire({
                title: 'Fitur Segera Hadir!',
                text: 'Fitur simpan pengaturan notifikasi sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                icon: 'info',
                confirmButtonText: 'Mengerti',
                confirmButtonColor: '#2C6B3F',
                customClass: {
        ...
        <form className="flex flex-col gap-5">
          ...
          <button
            ...
            onClick={(e) => {
              ...
              Swal.fire({
                title: 'Fitur Segera Hadir!',
                text: 'Fitur simpan preferensi privasi sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                icon: 'info',
                confirmButtonText: 'Mengerti',
                confirmButtonColor: '#2C6B3F',
                customClass: {
        ...
        <form className="flex flex-col gap-5">
          ...
          <button
            ...
            onClick={(e) => {
              ...
              Swal.fire({
                title: 'Fitur Segera Hadir!',
                text: 'Fitur simpan pengaturan bahasa sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                icon: 'info',
                confirmButtonText: 'Mengerti',
                confirmButtonColor: '#2C6B3F',
                customClass: {
          ...
          <article className="bg-[#F8FAF9] rounded-xl p-6 flex flex-col shadow-sm">
            ...
            <button
              onClick={() => {
                Swal.fire({
                  title: 'Fitur Segera Hadir!',
                  text: 'Fitur panduan pengguna sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                  icon: 'info',
                  confirmButtonText: 'Mengerti',
                  confirmButtonColor: '#2C6B3F',
                  customClass: {
          ...
          <article className="bg-[#F8FAF9] rounded-xl p-6 flex flex-col shadow-sm">
            ...
            <button
              onClick={() => {
                Swal.fire({
                  title: 'Fitur Segera Hadir!',
                  text: 'Fitur kirim feedback sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                  icon: 'info',
                  confirmButtonText: 'Mengerti',
                  confirmButtonColor: '#2C6B3F',
                  customClass: {
...
const Profile = () => {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    // Get activeTab from navigation state if available
    const tabMap = {
      'notifications': 2,
      'privacy': 3,
      'language': 4,
    ...
    return location.state?.activeTab ? tabMap[location.state.activeTab] || 0 : 0;
  });
  ...
  return (
    <section className="bg-white min-h-screen w-full z-20 font-nunito text-[#2C6B3F]">
          ...
          <main className="w-full md:w-2/3 flex flex-col gap-8">
            ...
            >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between bg-[#E8F5E9] rounded-lg p-4 mb-6 gap-4 border border-[#D1FADF]">
                ...
                <button 
                  className="bg-[#357A46] text-white font-semibold rounded-md py-2 px-6 flex items-center gap-3 hover:bg-green-800 transition"
                  onClick={() => {
                    Swal.fire({
                      title: 'Fitur Segera Hadir!',
                      text: 'Fitur tukar poin sedang dalam pengembangan. Mohon tunggu update selanjutnya.',
                      icon: 'info',
                      confirmButtonText: 'Mengerti',
                      confirmButtonColor: '#2C6B3F',
                      customClass: {
